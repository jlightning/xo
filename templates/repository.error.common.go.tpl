...
var ErrInvalidEnumScan = errgen.NewUnexpectedErr("Invalid enum value in DB")
var ErrInvalidEnumGraphQL = errgen.NewBadRequestErr("Invalid enum value from graphQL")
